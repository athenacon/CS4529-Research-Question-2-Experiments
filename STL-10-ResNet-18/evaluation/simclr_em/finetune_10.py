...
# Capsule Network
from capsule_network import resnet20, EmRoutingLoss
...
if __name__ == "__main__":
    ...
    full_dataset = STL10(root=args.dataset_dir, split="train", download=True, transform=None)
    ...
    train_loader = DataLoader(train_dataset, batch_size=args.logistic_batch_size, shuffle=True, num_workers=args.workers, pin_memory=True)
    valid_loader = DataLoader(val_dataset, batch_size=args.logistic_batch_size, shuffle=False, num_workers=args.workers, pin_memory=True)
 
    test_dataset = STL10(root=args.dataset_dir, split="test", transform=test_transform, download=True)
    test_loader = DataLoader(test_dataset, batch_size=args.logistic_batch_size, shuffle=False, num_workers=args.workers, pin_memory=True)
