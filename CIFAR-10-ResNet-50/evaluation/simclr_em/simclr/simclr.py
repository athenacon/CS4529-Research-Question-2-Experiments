...
class SimCLR(nn.Module):
    """
    We opt for simplicity and adopt the commonly used ResNet (He et al., 2016) to obtain hi = f(x Ìƒi) = ResNet(x Ìƒi) where hi âˆˆ Rd is the output after the average pooling layer.
    """
